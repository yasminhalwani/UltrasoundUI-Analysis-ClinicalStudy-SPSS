...
DESCRIPTIVES VARIABLES=stddevabspathangles
  /SAVE 

SORT CASES BY Zstddevabspathangles (A).

USE ALL. 
COMPUTE filter_$=(Zstddevabspathangles> -2.5 & Zstddevabspathangles< 2.5). 
VARIABLE LABELS filter_$ 'Zstddevabspathangles> -2.5 & Zstddevabspathangles< 2.5 (FILTER)'. 
VALUE LABELS filter_$ 0 'Not Selected' 1 'Selected'. 
FORMATS filter_$ (f1.0). 
FILTER BY filter_$. 
EXECUTE.

EXAMINE VARIABLES=stddevabspathangles BY INPUT_METHOD TECHNIQUE TARGET 
