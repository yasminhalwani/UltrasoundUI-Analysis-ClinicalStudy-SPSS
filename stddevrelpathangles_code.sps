...
DESCRIPTIVES VARIABLES=stddevrelpathangles
  /SAVE 

SORT CASES BY Zstddevrelpathangles (A).

USE ALL. 
COMPUTE filter_$=(Zstddevrelpathangles> -2.5 & Zstddevrelpathangles< 2.5). 
VARIABLE LABELS filter_$ 'Zstddevrelpathangles> -2.5 & Zstddevrelpathangles< 2.5 (FILTER)'. 
VALUE LABELS filter_$ 0 'Not Selected' 1 'Selected'. 
FORMATS filter_$ (f1.0). 
FILTER BY filter_$. 
EXECUTE.

EXAMINE VARIABLES=stddevrelpathangles BY INPUT_METHOD TECHNIQUE TARGET 
